...
'''
Using Reinforcement Learning: Q-Learning to play Pong from OpenAI's Gym
...
Environment: Pong World ?
Actuators: Game?
Sensors: pixels (position)
...
while True:
  ...
  if reward != 0: # Pong has either +1 or -1 reward exactly when game ends.
	...
	# credits to OpenAI and Andrej Karpathy and Siraj Raval